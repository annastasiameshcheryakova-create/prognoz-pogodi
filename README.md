Добре. Нижче — **ГОТОВИЙ README.md**, який **відповідає критеріям оцінювання** з твоєї таблиці.
Ти можеш **скопіювати 1:1** і покласти у корінь репозиторію.
...
* підлаштувати README **під конкретний предмет/університет**
* додати секцію **“Обмеження та майбутні покращення”**
* скоротити версію для **захисту або здачі**
